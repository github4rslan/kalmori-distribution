  ...
  return (
    <PublicLayout>
      <div className="max-w-2xl mx-auto" data-testid="publishing-page">
        ...
        {/* Stats */}
        <div className="mx-4 mt-4 bg-[#111] rounded-2xl flex justify-around py-6" data-reveal data-reveal-variant="zoom">
          {stats.map((s, i) => (
        ...
        <div className="p-4 space-y-4 mt-4">
          ...
          {services.map((s, i) => (
            <div key={i} className="bg-[#111] rounded-2xl p-5 text-center" data-testid={`pub-service-${i}`} data-reveal data-reveal-variant={['flip','tilt','zoom','rise'][i % 4]} data-reveal-delay={String((i % 4) + 1)}>
