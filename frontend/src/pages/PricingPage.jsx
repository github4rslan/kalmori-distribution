...
const plans = [
  {
    ...
    features: [
      ...
      { text: 'Join collaboration invites', included: true },
      ...
      { text: 'Manage collaborations', included: false },
    ],
  },
  {
    ...
    features: [
      ...
      { text: 'Collaboration management', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Producer Royalty Splits', included: true },
  ...
  return (
    <PublicLayout>
      <div className="max-w-6xl mx-auto px-4" data-testid="pricing-page">
        ...
        {/* Bottom CTA */}
        {!user && (
          <div className="py-12 text-center" data-reveal data-reveal-variant="scale">
