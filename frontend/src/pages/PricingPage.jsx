            ...
            <div key={plan.id} className={`bg-[#111] rounded-2xl overflow-hidden border-2 ${plan.highlight ? 'border-[#FFD700]' : 'border-[#222]'}`} data-testid={`plan-${plan.id}`}>
              ...
              <div className="p-6 text-center">
                ...
                <button onClick={() => navigate('/register')}
                  className={`px-8 py-3.5 rounded-full text-sm font-bold tracking-[2px] text-white bg-gradient-to-r ${plan.highlight ? 'from-[#FFD700] to-[#FFA500]' : 'from-[#7C4DFF] to-[#E040FB]'} hover:brightness-110 transition-all`}
