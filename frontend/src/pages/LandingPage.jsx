...
const LandingPage = () => {
  ...
  const handleSellBeats = () => {
    ...
    if (isProducer) return navigate('/beat-bank');
  ...
  return (
    <PublicLayout>
      ...
      {/* ===== FREE PLAN â€” Distribution Banner ===== */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: <Users className="w-7 h-7" weight="fill" />, color: '#2196F3', title: 'Collaboration Hub', desc: 'Find vocalists, producers, mixers, and songwriters. Post collabs, connect, and create together right inside Kalmori.', path: '/collaborations' },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: <Users className="w-7 h-7" weight="fill" />, color: '#FF9800', title: 'Collaboration Hub', desc: 'Post that you are open for work. Connect with vocalists, rappers, and other producers looking for beats and production.', path: '/collaborations' },
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              { icon: <Users className="w-7 h-7" weight="fill" />, color: '#E040FB', title: 'Collaboration Hub', desc: 'Post collaboration opportunities, find vocalists, producers, and engineers. Build your network and create together.', path: '/collaborations' },
