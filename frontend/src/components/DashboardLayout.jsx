...
const DashboardLayout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex">
      {sidebarOpen && <div className="fixed inset-0 z-[70] bg-black/55 backdrop-blur-[1px] lg:hidden" onClick={() => setSidebarOpen(false)} />}

      <aside className={`fixed lg:static top-0 bottom-0 left-0 z-[80] h-[100dvh] w-[86vw] max-w-[18rem] lg:h-screen lg:w-64 bg-[#0a0a0a] border-r border-white/10 shadow-2xl shadow-black/60 transform transition-transform duration-200 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
